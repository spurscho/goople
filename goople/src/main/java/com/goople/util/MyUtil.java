...
public class MyUtil {
	...
	public String pageIndexList(int currentPage, int totalPage, String listUrl){
		...
		if(totalPage > numPerBlock && currentPageSetup > 0){
			...
			sb.append("<a class=\"page-link\" href=\"" + listUrl + "pageNum=" 
		...
		while(page <= totalPage && page <= (currentPageSetup + numPerBlock)){
			...
			if(page == currentPage){				
				...
				sb.append("<font color=\"Fuchsia\" style=\" position: relative;\r\n" + 
						"    display: block;\r\n" + 
						"    padding: .5rem .75rem;\r\n" + 
						"    margin-left: -1px;\r\n" + 
						"    line-height: 1.25;\r\n" + 
				...
				sb.append("<a class=\"page-link\" href=\"" + listUrl + "pageNum=" + page + "\">"
						+ 
						"<font>"
						+page + "</font></a>&nbsp;");
		...
		if(totalPage - currentPageSetup > numPerBlock){
			...
			sb.append("<a class=\"page-link\" href=\"" + listUrl + "pageNum=" + page + "\">다음▶</a>&nbsp;");
